						...
						if($i == 0){
							...
							if (mysqli_num_rows($result) > 0) {
								while($row = mysqli_fetch_assoc($result)) {
									...
									echo "<div class='item active' style='background-image: url("."fotos/img/".$row['diretorio']."); background-position: center top; margin-top: 60px;'>
										<!--<a href='".$url.$id."'>									
							...
							if (mysqli_num_rows($result) > 0) {
								while($row = mysqli_fetch_assoc($result)) {
									...
									echo "<div class='item' style='background-image: url("."fotos/img/".$row['diretorio']."); background-position: center top; margin-top: 60px;'>
